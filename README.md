...
Replace the url string with the url string you just copied and replace where it says “<password>” with you cluster password.
...
Use nvm 18.0.0 which is a supported and stable version:
nvm install 18.0.0
...
Clone the ReactJS app repository:
git clone https://github.com/NehadTaha/Valcourt_app.git
...
To manually restart your React app, use:
pm2 restart Valcourt_app
